...
import {nextQuestion, selectCurrentQuestion, selectTraining} from '../../../features/training/trainingSlice';
    ...
    <Card className="quiz" title={QuestionTitle} style={{ width: 500 }}>
      ...
      {wasAnswered ? (
        <div className={style.quizFooter}>
          <AnswerInform />
          <span className={style.quizNextWord} onClick={handleNextQuestionLink}>Next word</span>
        </div>
      ) : null}
    </Card>
  );
